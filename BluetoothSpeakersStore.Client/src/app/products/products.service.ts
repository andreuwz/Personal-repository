...
export class ProductService {
  ...
  private getAllProductsUrl = 'https://localhost:7193/Product';
  private getAllProductsAsAdminUrl = 'https://localhost:7193/Product/Admin';
  private createProductUrl = 'https://localhost:7193/Product';
  private deleteProductUrl = 'https://localhost:7193/Product';
  private updateProductUrl = 'https://localhost:7193/Product';
  private getAdminProductUrl = 'https://localhost:7193/Product/Admin';
  private addProductToCartUrl = 'https://localhost:7193/Product/AddToCart';
