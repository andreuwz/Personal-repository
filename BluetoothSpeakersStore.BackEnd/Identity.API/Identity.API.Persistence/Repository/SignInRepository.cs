...
{
    public class SignInRepository : SignInManager<User>, ISignInRepository
    {
        public SignInRepository(UserManager<User> userManager, IHttpContextAccessor contextAccessor,
