...
namespace Identity.API.Common
{
    public class AppConstants
    {
        ...
        public const string userInCheckout = "--> New information about user in checkout was published and retrieved";
        ...
        public const string eventAcquireUserBalance = "AcquireUserBalance";
