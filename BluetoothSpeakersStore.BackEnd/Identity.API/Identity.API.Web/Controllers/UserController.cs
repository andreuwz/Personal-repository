...
namespace Identity.API.Web.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public UserController(IGetAllUsers getAllUsers, IMapper mapper, IGetUser getUser, ICreateUser createUser
            ...
            IAccessTokenIssuer tokenIssuer, IPublishNewMessage publishNewMessage)
        {
        ...
        public async Task<IActionResult> EdiUserAsync(Guid id, AdminEditUserModel userModel)
        {
            if (ModelState.IsValid)
            {
                var updatedUser = await updateUser.UpdateUserAsync(id, userModel);
                await publishNewMessage.PublishUpdatedUserDataMessageAsync(updatedUser);
        ...
        {
            var userForDelete = await deleteUser.DeleteUserAsync(id);
            publishNewMessage.PublishDeletedUserDataMessageAsync(userForDelete);
        ...
        public async Task<IActionResult> EditLoggedUser(EditUserModel userModel)
        {
            if (ModelState.IsValid)
            {
                ...
                await publishNewMessage.PublishUpdatedUserDataMessageAsync(loggedUser);
