...
namespace Identity.API.DTO.Request
{
    public class EditUserModel
    {
        ...
        [Required]
        [Range(double.Epsilon, double.MaxValue, ErrorMessage = "Enter proper amount of money.")]
        [RegularExpression(@"^(-?)(0|([1-9][0-9]*))(\\.[0-9]+)?$", ErrorMessage = "Enter proper amount of money.")]
